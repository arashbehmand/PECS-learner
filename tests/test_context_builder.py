...
def test_build_learning_context_empty_pecs_data():
    ...
    assert not context["conversations"]
...
def test_build_learning_context_with_all_phases():
    ...
    assert (
        context["explanation"] == "Python is a high-level language with simple syntax."
    )
...
def test_build_learning_context_partial_phase_data():
    ...
    pecs_data = {
        "prime_preview": {"understanding": "Initial thoughts", "completed": True},
        "engage_explain": {
            # No explanation yet
            "completed": False
        },
...
def test_full_workflow_flashcard_generation():
    ...
    pecs_data = {
        "prime_preview": {"understanding": "Python seems powerful", "completed": True},
        "engage_explain": {
    ...
    flashcards = [{"question": "What is a variable?", "answer": "A named storage"}]
...
def test_full_workflow_completion_report():
    ...
    pecs_data = {
        ...
        "engage_explain": {"explanation": "Detailed explanation", "completed": True},
    }
