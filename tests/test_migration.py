...
def test_migrate_json_to_database_success(temp_db):
    ...
    success, message = migrate_json_to_database(json_str, temp_db, "Test Project")

    assert success is True
    assert "Migration complete" in message
    assert "3 sections" in message
...
def test_migrate_json_to_database_invalid_json(temp_db):
    ...
    success, message = migrate_json_to_database(invalid_json, temp_db, "Test Project")
