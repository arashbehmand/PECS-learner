...
class HierarchicalContentProcessor:
    ...
    def split_into_sections(
        ...
        for i, (line_num, title, start_pos) in enumerate(detected_sections):
            ...
            if len(section_content) < min_section_size and sections:
                ...
                if sections:
                    ...
                    sections[-1] = (prev_content + "\n\n" + section_content, prev_title or title)
                    continue
    ...
    def process_for_user(
        ...
        if use_custom_markers and custom_markers:
            ...
            try:
                result = self.split_into_sections(text, min_section_size, max_section_size, overlap)
            finally:
                self.section_patterns = original_patterns
            return result
        
        return self.split_into_sections(text, min_section_size, max_section_size, overlap)
